...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class ExplorerScrollRect : UIBehaviour, IInitializePotentialDragHandler,IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        //自定义纵拉条长度
        private float m_CustomVerticalSize = -1.0f;
        public float customVerticalSize {
            get
            {
                return m_CustomVerticalSize;
            }
            set
            {
