...
using UI.DynamicScrollView.Runtime.ObjPool;
...
namespace UI.DynamicScrollView.Runtime.ScrollView
{
    ...
    public class ScrollView : ScrollRect
    {
        ...
        private void UpdateRefRect()
        {
            ...
            //?this.refRect = new Rect((Vector2)this.rectCorners[0] - this.content.anchoredPosition, viewRect.rect.size);
        }
