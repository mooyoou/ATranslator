...
namespace UI.DynamicScrollView.Editor
{
    ...
    public class ScrollViewEditor : ScrollRectEditor
    {
        ...
        private GUIStyle caption
        {
            get
            {
                if (this.cachedCaption == null)
                {
                    ...
                    cachedCaption.normal.textColor = Color.white;
                }
        ...
        protected override void OnEnable()
        {
            ...
            this.draggable = this.serializedObject.FindProperty("draggable");
        ...
        protected virtual void DrawConfigInfo()
        {
            ...
            EditorGUILayout.PropertyField(this.draggable);
